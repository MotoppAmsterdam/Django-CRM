...
const statusStyles: {
  ...
  assigned: {
    backgroundColor: '#3E79F761',
    borderColor: '#3E79F7',
    color: '#3E79F7',
  },
  'in process': {
    backgroundColor: '#F7C94861',
    borderColor: '#F7C948',
    color: '#FFBC00',
  },
  converted: {
    backgroundColor: '#2DCC7061',
    borderColor: '#2DCC70',
    color: '#00903D',
  },
  recycled: {
    backgroundColor: '#F7883E61',
    borderColor: '#F7883E',
    color: '#FF6905',
  },
  closed: {
    backgroundColor: '#A0A0A061',
    borderColor: '#A0A0A0',
    color: '#747474',
  },
};
  ...
  return (
    <Box sx={{ mt: '60px' }}>
      <CustomToolbar sx={{ flexDirection: 'row-reverse' }}>
        ...
        >
          {selectedTab === 0 && ( // Only show these components when List View is selected
            <>
              <Select
      ...
      <Container sx={{ width: '100%', maxWidth: '100%', minWidth: '100%' }}>
                            ...
                            >
                              ...
                              <TableCell>
                                <Box
                                  sx={{
                                    border: `1px solid ${
                                      statusStyles[item.status]?.borderColor ||
        ...
        {/* Pagination */}
        {selectedTab === 0 && ( // Only show pagination buttons in List View
          <Box
            sx={{
              display: 'flex',
